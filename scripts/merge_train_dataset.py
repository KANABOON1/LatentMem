...
def build_datasets_and_databases_path(
    ...
    for dataset in datasets:
        dataset_path = os.path.join(
            root_path, model_name, dataset, mas_type, f"mem={memory_type}", "rag_0", "data.json"
        )
        datasets_path.append(dataset_path)

        database_path = os.path.join(
            root_path, model_name, dataset, mas_type, f"mem={memory_type}", "rag_0"
        )
...
def get_output_file_path(
    ...
    return os.path.join(root_path, model_name, "in_domain", mas_type, memory_type, "data.json")
...
def get_output_folder(
    ...
    return os.path.join(root_path, model_name, "in_domain", mas_type, memory_type, "rag_0")
