...
from memmaster.trainer import (
    MemMasterGRPOTrainer,
    MemMasterSFTTrainer
)
from memmaster.utils.data import (
    rag_to_structured_json,
    structured_json_to_trajectories
)
from memmaster.utils.message import Trajectory
from memmaster.utils.tools import remove_trainer_ckpts
...
class LatentMemRunner:
    ...
    def train(self, mode: Literal["sft", "grpo"]):
        ...
        if mode == "sft":
            ...
            self.trainer = MemMasterGRPOTrainer(
